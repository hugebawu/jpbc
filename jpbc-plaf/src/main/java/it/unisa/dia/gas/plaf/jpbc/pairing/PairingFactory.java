...
public class PairingFactory {
	...
	public static class CTL13MultilinearPairingCreator implements PairingCreator {
		...
		public CTL13MultilinearPairingCreator() {
			try {
				Class pbcPairingFactoryClass = Class
						.forName("it.unisa.dia.gas.plaf.jpbc.mm.clt13.pairing.CTL13PairingFactory");
				getPairingMethod = pbcPairingFactoryClass.getMethod("getPairing", SecureRandom.class,
						PairingParameters.class);
			} catch (Exception e) {
				throwable = e;
			}
	...
	public class EllipticCurvesPairingCreator implements PairingCreator {
		...
		public EllipticCurvesPairingCreator() {
			// Try to load jpbc-* factory
			try {
				Class pbcPairingFactoryClass = Class.forName("it.unisa.dia.gas.plaf.jpbc.*.PBCPairingFactory");
